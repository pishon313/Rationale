...
export function toAccountSyncPayload(account: InvestmentAccount): AccountSyncPayloadV1 {
  return { id: account.id, name: account.name, institution: account.institution, kind: account.kind, subtype: account.subtype, baseCurrency: account.baseCurrency, archivedAt: account.archivedAt, memo: account.memo, ...(account.feePolicy === undefined ? {} : { feePolicy: account.feePolicy }), ...(account.cashTracking === undefined ? {} : { cashTracking: account.cashTracking }), createdAt: account.createdAt, updatedAt: account.updatedAt };
}

...
const valid = { ticker: " tsla ", name: "Tesla", market: "미국", currency: "USD", countryCode: "", exchangeCode: "", providerSymbol: "", provider: "manual", assetType: "주식", sector: "자동차", status: "관찰", investmentType: "중기 투자", currentPrice: "312.5", targetPrice: "350", averagePrice: "0", quantity: "0", thesisSummary: "관찰", currentView: "중립", currentViewMemo: "", nextReviewDate: "", reviewNote: "판매량 확인", nextEarningsDate: "2026-10-21", tagsText: "미국, 자동차" };

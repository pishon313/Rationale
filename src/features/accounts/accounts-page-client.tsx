...
export function AccountsPageClient() {
  ...
  async function merge(target: string) {
    if (!window.confirm(t("선택한 계좌의 모든 거래를 대상 계좌로 이동할까요? 대상 계좌의 수수료 정책은 유지되고, 기존 거래 수수료는 변경되지 않습니다."))) return;

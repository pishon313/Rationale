...
export function PeriodicReportSection({ trades, reviews, ledger }: { trades: Trade[]; reviews: Review[]; ledger: TradingLedger }) {
  ...
  const metrics = [
    ...
    [t("계획 매매율"), report.tradeCount ? formatNumber(report.plannedTradeRate / 100, { style: "percent", minimumFractionDigits: 1, maximumFractionDigits: 1 }) : "—"],

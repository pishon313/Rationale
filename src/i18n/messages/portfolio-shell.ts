...
const entries = [
  ...
  ["단일 포트폴리오 · V1", "単一ポートフォリオ · V1", "Single portfolio · V1", "Portefeuille unique · V1", "Portafoglio singolo · V1", "Cartera única · V1"],
  ...
  ["기준일", "基準日", "As of", "À la date du", "Alla data del", "A fecha de"],
  ["활성 Plan", "有効なプラン", "Active plan", "Plan actif", "Piano attivo", "Plan activo"],
  ["활성 Plan 없음", "有効なプランなし", "No active plan", "Aucun plan actif", "Nessun piano attivo", "Ningún plan activo"],

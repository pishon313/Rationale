...
import { portfolioShellMessages } from "./portfolio-shell";
import { tradeCentricLedgerMessages } from "./trade-centric-ledger";
import { themeMessages } from "./theme";

const catalogs: MessageCatalog[] = [themeMessages, tradeCentricLedgerMessages, portfolioShellMessages, portfolioPlanMessages, tradeLedgerResetMessages, registeredStockPickerMessages, tradeFeeMessages, accountFeeMessages, portfolioClassificationMessages, importMessages, marketObservationMessages, systemLanguageMessages, sampleEscapedMessages, sampleDataMessages, commonMessages, appMessages, stockMessages, stockAccountMessages, tradeMessages, journalMessages, securityMessages, redesignMessages, dashboardMessages, accountMessages];
